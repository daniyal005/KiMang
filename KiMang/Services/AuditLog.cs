...
namespace KiMang.Services
{
    public class AuditLog
    {
        ...
        public virtual void InsertUserActivityLogs(string Userid,string Name, string ModuleName,string Action,string Profession, string Desc)
        {
                ...
                auditLog.USERID = Userid.ToString();
